        ...
        <SafeAreaView className="flex-1 bg-green-500">
            <View className="w-5/6 mt-8 mx-auto flex-row align-middle justify-between">
                ...
                <View className="flex-row ">
                    <Text className="text-white text-sm font-extrabold mx-2 my-auto">
                        Hello Khang
                    </Text>
                    <Image
            ...
            <View className="w-1/5 mt-4 mx-auto">
                <Image
                    ...
                    source={{
                        uri: 'https://assets.grab.com/wp-content/uploads/media/ir/logo/Grab_Final_Master_Logo_2021_RGB_(white).png'
                    }}
                />
            </View>
                ...
                <View className="mx-4 flex-row flex-wrap justify-around">
                    ...
                    <View className="rounded-lg my-2 border-2 bg-green-400 border-green-500 mt-2 w-2/5 h-2/5 ">
                        <Image
                            className="h-1/2 w-3/4 mx-auto mt-2 mb-1"
                            source={{
                                uri: 'https://freepngimg.com/save/23276-motorbike-transparent/1024x768'
                            }}
                        />
                    ...
                    <View className="rounded-lg my-2 border-2 bg-green-400 border-green-500 mt-2 w-2/5 h-2/5 ">
                        <Image
                            className="h-1/2 w-3/4 mx-auto mt-2 mb-1"
                            source={{
                                uri: 'https://www.pngplay.com/wp-content/uploads/2/Truck-Transparent-Background.png'
                            }}
                        />
